...
use Walva\HafBundle\Entity\Reference;
use Walva\HafBundle\Form\ReferenceType;
...
class ReferenceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WalvaHafBundle:Reference')->findAll();

        return $this->render('WalvaHafBundle:Reference:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('WalvaHafBundle:Reference:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WalvaHafBundle:Reference')->find($id);
        ...
        return $this->render('WalvaHafBundle:Reference:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('WalvaHafBundle:Reference:edit.html.twig', array(
            'entity'      => $entity,
