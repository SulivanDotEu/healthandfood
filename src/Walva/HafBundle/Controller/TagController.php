...
class TagController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('WalvaHafBundle:Tag:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WalvaHafBundle:Tag')->find($id);
        ...
        return $this->render('WalvaHafBundle:Tag:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('WalvaHafBundle:Tag:edit.html.twig', array(
            'entity'      => $entity,
